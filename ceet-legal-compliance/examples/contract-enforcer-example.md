# Ejemplo realista — Contract Enforcer Skill — {counsel_name}

## Escenario

Un equipo usa el skill `contract-enforcer` durante una tarea operativa real del rol `ceet-legal-compliance`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
