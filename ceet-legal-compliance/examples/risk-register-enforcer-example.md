# Ejemplo realista — Risk Register Enforcer Skill — {counsel_name}

## Escenario

Un equipo usa el skill `risk-register-enforcer` durante una tarea operativa real del rol `ceet-legal-compliance`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
