# Ejemplo realista — Unit Economics Enforcer Skill — {finance_name}

## Escenario

Un equipo usa el skill `unit-economics-enforcer` durante una tarea operativa real del rol `ceet-financial`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
