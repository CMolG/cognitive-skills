# Ejemplo realista — Assumptions Enforcer Skill — {finance_name}

## Escenario

Un equipo usa el skill `assumptions-enforcer` durante una tarea operativa real del rol `ceet-financial`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
