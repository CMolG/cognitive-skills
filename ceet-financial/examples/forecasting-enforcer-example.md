# Ejemplo realista — Forecasting Enforcer Skill — {finance_name}

## Escenario

Un equipo usa el skill `forecasting-enforcer` durante una tarea operativa real del rol `ceet-financial`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
