# Ejemplo realista — Runbook Generator Skill — {engineer_name}

## Escenario

Un equipo usa el skill `runbook-generator` durante una tarea operativa real del rol `ceet-devops-sre`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
