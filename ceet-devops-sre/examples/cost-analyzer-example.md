# Ejemplo realista — Cost Analyzer Skill — {engineer_name}

## Escenario

Un equipo usa el skill `cost-analyzer` durante una tarea operativa real del rol `ceet-devops-sre`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
