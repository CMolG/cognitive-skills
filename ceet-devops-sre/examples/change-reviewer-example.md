# Ejemplo realista — Change Reviewer Skill — {engineer_name}

## Escenario

Un equipo usa el skill `change-reviewer` durante una tarea operativa real del rol `ceet-devops-sre`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
