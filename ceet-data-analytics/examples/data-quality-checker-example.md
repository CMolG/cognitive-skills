# Ejemplo realista — Data Quality Checker Skill — {analyst_name}

## Escenario

Un equipo usa el skill `data-quality-checker` durante una tarea operativa real del rol `ceet-data-analytics`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
