# Ejemplo realista — Documentation Generator Skill — {analyst_name}

## Escenario

Un equipo usa el skill `documentation-generator` durante una tarea operativa real del rol `ceet-data-analytics`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
