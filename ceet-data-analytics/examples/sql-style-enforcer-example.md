# Ejemplo realista — Sql Style Enforcer Skill — {analyst_name}

## Escenario

Un equipo usa el skill `sql-style-enforcer` durante una tarea operativa real del rol `ceet-data-analytics`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
