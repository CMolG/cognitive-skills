# Ejemplo realista — Hiring Enforcer Skill — {founder_name}

## Escenario

Un equipo usa el skill `hiring-enforcer` durante una tarea operativa real del rol `ceet-founder-ceo`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
