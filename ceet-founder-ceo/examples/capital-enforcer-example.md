# Ejemplo realista — Capital Enforcer Skill — {founder_name}

## Escenario

Un equipo usa el skill `capital-enforcer` durante una tarea operativa real del rol `ceet-founder-ceo`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
