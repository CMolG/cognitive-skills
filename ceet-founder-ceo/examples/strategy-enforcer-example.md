# Ejemplo realista — Strategy Enforcer Skill — {founder_name}

## Escenario

Un equipo usa el skill `strategy-enforcer` durante una tarea operativa real del rol `ceet-founder-ceo`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
