# Ejemplo realista — Leveling Comp Enforcer Skill — {hr_name}

## Escenario

Un equipo usa el skill `leveling-comp-enforcer` durante una tarea operativa real del rol `ceet-people-ops`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
