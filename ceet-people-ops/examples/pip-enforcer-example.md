# Ejemplo realista — Pip Enforcer Skill — {hr_name}

## Escenario

Un equipo usa el skill `pip-enforcer` durante una tarea operativa real del rol `ceet-people-ops`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
