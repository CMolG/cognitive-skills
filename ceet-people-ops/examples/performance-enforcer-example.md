# Ejemplo realista — Performance Enforcer Skill — {hr_name}

## Escenario

Un equipo usa el skill `performance-enforcer` durante una tarea operativa real del rol `ceet-people-ops`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
