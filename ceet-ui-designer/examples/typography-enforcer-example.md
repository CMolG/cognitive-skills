# Ejemplo realista — Typography Enforcer Skill — {designer_name}

## Escenario

Un equipo usa el skill `typography-enforcer` durante una tarea operativa real del rol `ceet-ui-designer`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
