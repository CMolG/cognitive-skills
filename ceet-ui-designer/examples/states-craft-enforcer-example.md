# Ejemplo realista — States Craft Enforcer Skill — {designer_name}

## Escenario

Un equipo usa el skill `states-craft-enforcer` durante una tarea operativa real del rol `ceet-ui-designer`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
