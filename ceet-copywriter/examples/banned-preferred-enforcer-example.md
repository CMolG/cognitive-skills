# Ejemplo realista — Banned Preferred Enforcer Skill — {writer_name}

## Escenario

Un equipo usa el skill `banned-preferred-enforcer` durante una tarea operativa real del rol `ceet-copywriter`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
