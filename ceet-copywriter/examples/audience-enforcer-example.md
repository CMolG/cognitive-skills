# Ejemplo realista — Audience Enforcer Skill — {writer_name}

## Escenario

Un equipo usa el skill `audience-enforcer` durante una tarea operativa real del rol `ceet-copywriter`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
