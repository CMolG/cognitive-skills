# Ejemplo realista — Code Style Enforcer Skill — {engineer_name}

## Escenario

Un equipo usa el skill `code-style-enforcer` durante una tarea operativa real del rol `ceet-backend-engineer`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
