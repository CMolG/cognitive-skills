# Ejemplo realista — Security Auditor Skill — {engineer_name}

## Escenario

Un equipo usa el skill `security-auditor` durante una tarea operativa real del rol `ceet-backend-engineer`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
