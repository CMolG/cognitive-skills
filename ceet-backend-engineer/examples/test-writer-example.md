...
Un equipo usa el skill `test-writer` durante una tarea operativa real del rol `ceet-backend-engineer`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
