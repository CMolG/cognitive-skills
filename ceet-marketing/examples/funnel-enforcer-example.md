# Ejemplo realista — Funnel Enforcer Skill — {marketer_name}

## Escenario

Un equipo usa el skill `funnel-enforcer` durante una tarea operativa real del rol `ceet-marketing`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
