# Ejemplo realista — Channels Enforcer Skill — {marketer_name}

## Escenario

Un equipo usa el skill `channels-enforcer` durante una tarea operativa real del rol `ceet-marketing`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
