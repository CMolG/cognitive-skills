# Ejemplo realista — Method Selection Enforcer Skill — {researcher_name}

## Escenario

Un equipo usa el skill `method-selection-enforcer` durante una tarea operativa real del rol `ceet-ux-researcher`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
