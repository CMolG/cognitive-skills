# Ejemplo realista — Behavioral Vs Attitudinal Enforcer Skill — {researcher_name}

## Escenario

Un equipo usa el skill `behavioral-vs-attitudinal-enforcer` durante una tarea operativa real del rol `ceet-ux-researcher`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
