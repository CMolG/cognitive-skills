# Ejemplo realista — Interview Craft Enforcer Skill — {researcher_name}

## Escenario

Un equipo usa el skill `interview-craft-enforcer` durante una tarea operativa real del rol `ceet-ux-researcher`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
