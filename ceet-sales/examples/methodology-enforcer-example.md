# Ejemplo realista — Methodology Enforcer Skill — {seller_name}

## Escenario

Un equipo usa el skill `methodology-enforcer` durante una tarea operativa real del rol `ceet-sales`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
