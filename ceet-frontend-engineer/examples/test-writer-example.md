# Ejemplo realista — Test Writer Skill — {engineer_name}

## Escenario

Un equipo usa el skill `test-writer` durante una tarea operativa real del rol `ceet-frontend-engineer`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
