# Ejemplo realista — Documentation Generator Skill — {engineer_name}

## Escenario

Un equipo usa el skill `documentation-generator` durante una tarea operativa real del rol `ceet-frontend-engineer`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
