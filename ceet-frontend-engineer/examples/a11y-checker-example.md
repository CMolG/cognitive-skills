# Ejemplo realista — A11Y Checker Skill — {engineer_name}

## Escenario

Un equipo usa el skill `a11y-checker` durante una tarea operativa real del rol `ceet-frontend-engineer`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
