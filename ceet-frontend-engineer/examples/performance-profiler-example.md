# Ejemplo realista — Performance Profiler Skill — {engineer_name}

## Escenario

Un equipo usa el skill `performance-profiler` durante una tarea operativa real del rol `ceet-frontend-engineer`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
