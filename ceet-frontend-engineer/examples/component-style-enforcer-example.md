# Ejemplo realista — Component Style Enforcer Skill — {engineer_name}

## Escenario

Un equipo usa el skill `component-style-enforcer` durante una tarea operativa real del rol `ceet-frontend-engineer`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
