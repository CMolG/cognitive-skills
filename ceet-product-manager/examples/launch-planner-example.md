# Ejemplo realista — Launch Planner Skill — {pm_name}

## Escenario

Un equipo usa el skill `launch-planner` durante una tarea operativa real del rol `ceet-product-manager`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
