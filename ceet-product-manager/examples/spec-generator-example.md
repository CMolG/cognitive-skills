# Ejemplo realista — Spec Generator Skill — {pm_name}

## Escenario

Un equipo usa el skill `spec-generator` durante una tarea operativa real del rol `ceet-product-manager`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
