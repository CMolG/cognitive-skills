# Ejemplo realista — Prioritization Calculator Skill — {pm_name}

## Escenario

Un equipo usa el skill `prioritization-calculator` durante una tarea operativa real del rol `ceet-product-manager`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
