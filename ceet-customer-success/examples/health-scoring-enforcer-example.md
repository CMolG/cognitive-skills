# Ejemplo realista — Health Scoring Enforcer Skill — {csm_name}

## Escenario

Un equipo usa el skill `health-scoring-enforcer` durante una tarea operativa real del rol `ceet-customer-success`. El objetivo es producir una respuesta utilizable inmediatamente, no un ejemplo vacío.
